						...
						<div class="header__menu">
							...
							<nav class="onepage-nav">
								...
								<ul class="onepage-menu">
									...
									<li><a href="#id-2" style="color: #333;">Profil</a>
									</li>
									<li><a href="#id-3" style="color: #333;">Artikel Kegiatan</a>
									</li>
									<li><a href="#id-4" style="color: #333;">Buat Kegiatan</a>
									</li>
			...
			<div class="md-content">
				...
				<section class="md-section bg-gray" id="id-4">
					...
					<h1 style="padding-bottom:1%; padding-left:1.3%" > Buat Kegiatan </h1>
						...
						<div class="form-group">
							<input type="text" placeholder="Isikan Deskripsi Kegiatan" name="isikegiatan" required>
						</div>
						<div class="form-group">
							<input type="text" placeholder="Tempat Kegiatan" name="tempat" required>
						</div>
						<div class="form-group">
							<input type="text" placeholder="Tanggal Kegiatan" name="tanggal" required>
						</div>
						</form>
					<div style="padding-left:1.3%">
					<button method="post" class="btn btn-primary btn-md" href="<?php blink('') ?>"> POST </button>
					<button method="post" class="btn btn-warning btn-md" href="<?php blink('') ?>"> BATAL </button>
					</div>
					</div>
